...
### F2 — Status-bucketed review queue (UX, 2026-06-11) — IN PROGRESS
...
- [ ] Live-validate on the fresh DB (ingest → To Review oldest-first w/ counts → sync → moves to History; confirm fresh extraction now carries card_last_four).
